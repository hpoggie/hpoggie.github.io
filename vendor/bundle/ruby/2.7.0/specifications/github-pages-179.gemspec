# -*- encoding: utf-8 -*-
# stub: github-pages 179 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<github-pages-health-check>.freeze, ["= 1.4.0"])
    ...
    s.add_runtime_dependency(%q<minima>.freeze, ["= 2.4.0"])
    ...
    s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.8.1", "< 2.0"])
    ...
    s.add_dependency(%q<github-pages-health-check>.freeze, ["= 1.4.0"])
    ...
    s.add_dependency(%q<minima>.freeze, ["= 2.4.0"])
    ...
    s.add_dependency(%q<nokogiri>.freeze, [">= 1.8.1", "< 2.0"])
